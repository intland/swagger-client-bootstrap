...
public class AttachmentApi {
     ...
     */
    public okhttp3.Call updateAttachmentCall(Integer attachmentId, File content, String description, String descriptionFormat, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateAttachmentValidateBeforeCall(Integer attachmentId, File content, String description, String descriptionFormat, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateAttachmentCall(attachmentId, content, description, descriptionFormat, _callback);
        return localVarCall;
     ...
     */
    public Attachment updateAttachment(Integer attachmentId, File content, String description, String descriptionFormat) throws ApiException {
        ApiResponse<Attachment> localVarResp = updateAttachmentWithHttpInfo(attachmentId, content, description, descriptionFormat);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Attachment> updateAttachmentWithHttpInfo(Integer attachmentId, File content, String description, String descriptionFormat) throws ApiException {
        okhttp3.Call localVarCall = updateAttachmentValidateBeforeCall(attachmentId, content, description, descriptionFormat, null);
        Type localVarReturnType = new TypeToken<Attachment>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call updateAttachmentAsync(Integer attachmentId, File content, String description, String descriptionFormat, final ApiCallback<Attachment> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateAttachmentValidateBeforeCall(attachmentId, content, description, descriptionFormat, _callback);
        Type localVarReturnType = new TypeToken<Attachment>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
