...
public class UserApi {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public UserSearchResult getUsers(Integer page, Integer pageSize, Integer groupId, String queryString) throws ApiException {
        ApiResponse<UserSearchResult> localVarResp = getUsersWithHttpInfo(page, pageSize, groupId, queryString);
        return localVarResp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<UserSearchResult> getUsersWithHttpInfo(Integer page, Integer pageSize, Integer groupId, String queryString) throws ApiException {
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public okhttp3.Call getUsersAsync(Integer page, Integer pageSize, Integer groupId, String queryString, final ApiCallback<UserSearchResult> _callback) throws ApiException {
