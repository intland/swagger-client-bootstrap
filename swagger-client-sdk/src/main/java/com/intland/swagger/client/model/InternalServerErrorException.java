...
public class InternalServerErrorException {
  ...
  * @throws IOException if the JSON Object is invalid with respect to InternalServerErrorException
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (InternalServerErrorException.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in InternalServerErrorException is not found in the empty JSON string", InternalServerErrorException.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!InternalServerErrorException.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `InternalServerErrorException` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!InternalServerErrorException.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'InternalServerErrorException' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<InternalServerErrorException> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(InternalServerErrorException.class));

       return (TypeAdapter<T>) new TypeAdapter<InternalServerErrorException>() {
           @Override
