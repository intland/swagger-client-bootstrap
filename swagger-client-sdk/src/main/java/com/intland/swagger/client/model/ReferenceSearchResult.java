...
public class ReferenceSearchResult {
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReferenceSearchResult
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ReferenceSearchResult.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReferenceSearchResult is not found in the empty JSON string", ReferenceSearchResult.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ReferenceSearchResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReferenceSearchResult` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonArrayreferences != null) {
        ...
        for (int i = 0; i < jsonArrayreferences.size(); i++) {
          AbstractReference.validateJsonObject(jsonArrayreferences.get(i).getAsJsonObject());
        };
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReferenceSearchResult.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReferenceSearchResult' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReferenceSearchResult> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReferenceSearchResult.class));

       return (TypeAdapter<T>) new TypeAdapter<ReferenceSearchResult>() {
           @Override
           public void write(JsonWriter out, ReferenceSearchResult value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReferenceSearchResult read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ReferenceSearchResult given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReferenceSearchResult
  * @throws IOException if the JSON string is invalid with respect to ReferenceSearchResult
  */
  public static ReferenceSearchResult fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReferenceSearchResult.class);
  }

 /**
  * Convert an instance of ReferenceSearchResult to an JSON string
  *
  * @return JSON string
  */
