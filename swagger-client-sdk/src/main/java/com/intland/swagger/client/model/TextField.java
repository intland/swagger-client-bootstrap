...
public class TextField extends AbstractField {
  ...
  * @throws IOException if the JSON Object is invalid with respect to TextField
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (TextField.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TextField.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TextField` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  }
