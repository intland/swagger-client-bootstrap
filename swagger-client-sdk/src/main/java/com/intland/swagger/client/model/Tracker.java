...
public class Tracker {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, description, descriptionFormat, keyName, version, createdAt, createdBy, modifiedAt, modifiedBy, type, deleted, hidden, color, usingWorkflow, onlyWorkflowCanCreateNewReferringItem, usingQuickTransitions, defaultShowAncestorItems, defaultShowDescendantItems, project, templateTracker, availableAsTemplate);
  }
