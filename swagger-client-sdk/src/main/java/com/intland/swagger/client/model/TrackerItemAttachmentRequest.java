...
public class TrackerItemAttachmentRequest extends TrackerItemsRequest {
  ...
  * @throws IOException if the JSON Object is invalid with respect to TrackerItemAttachmentRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (TrackerItemAttachmentRequest.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in TrackerItemAttachmentRequest is not found in the empty JSON string", TrackerItemAttachmentRequest.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!TrackerItemAttachmentRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TrackerItemAttachmentRequest` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TrackerItemAttachmentRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TrackerItemAttachmentRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TrackerItemAttachmentRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TrackerItemAttachmentRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<TrackerItemAttachmentRequest>() {
           @Override
           public void write(JsonWriter out, TrackerItemAttachmentRequest value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TrackerItemAttachmentRequest read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of TrackerItemAttachmentRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TrackerItemAttachmentRequest
  * @throws IOException if the JSON string is invalid with respect to TrackerItemAttachmentRequest
  */
  public static TrackerItemAttachmentRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TrackerItemAttachmentRequest.class);
  }

 /**
  * Convert an instance of TrackerItemAttachmentRequest to an JSON string
  *
  * @return JSON string
  */
