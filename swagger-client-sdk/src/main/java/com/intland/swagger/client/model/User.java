...
import com.intland.swagger.client.model.UserAllOf;
...
public class User extends UserReference {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, uri, name, type, firstName, lastName, email, title, company, address, zip, city, state, country, dateFormat, timeZone, language, phone, skills, registryDate, lastLoginDate, status, super.hashCode());
  }
