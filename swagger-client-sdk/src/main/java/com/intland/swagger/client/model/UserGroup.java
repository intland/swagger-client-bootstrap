...
import com.intland.swagger.client.model.UserGroupAllOf;
...
public class UserGroup extends UserGroupReference {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, uri, name, type, description, super.hashCode());
  }
